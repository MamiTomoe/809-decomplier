...
private:
	...
	std::vector<std::string> _stackVars;
	...
	std::map<string, std::variant<std::unique_ptr<X8008Symbols>, std::unique_ptr<X8086Symbols>, std::unique_ptr<X86Symbols>, std::unique_ptr<X64Symbols>>> _archFound;
